...
import at.wrk.fmd.mls.amqp.dto.ReplayStartDto;
 ...
 */
public abstract class AbstractAmqpHandler<T> implements EventHandler<AmqpEvent> {
     ...
     */
    public AbstractAmqpHandler(final AmqpTemplate amqpTemplate, final String target) {
    ...
    @Override
    public void handle(final AmqpEvent event) {
