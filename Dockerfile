...
COPY  ./pom.xml                    ./
COPY  ./amqp-common/pom.xml        ./amqp-common/
COPY  ./eventbus/pom.xml           ./eventbus/
COPY  ./stomp-application/pom.xml  ./stomp-application/
COPY  ./stomp-endpoint/pom.xml     ./stomp-endpoint/
